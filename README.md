Develop a Spring Boot-based REST API to manage products for an e-commerce platform. The API should support CRUD operations for products, and each product should have the following attributes:
